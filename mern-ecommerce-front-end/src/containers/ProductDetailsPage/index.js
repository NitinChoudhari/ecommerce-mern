...
const ProductdetailsPage = (props) => {
    ...
    const addItemToCart = () =>{
        ...
        const img = product.productDetails.productImage[0].img;
            ...
            <div className="productDescriptionContainer">
                <div className="flexRow">
                    <div className="verticalImageStack">
                        {
                            product.productDetails.productImage.map((thumb, index) =>
                ...
                <img src={generatePublicURL(thumb.img)} alt={thumb.img} />)
                    ...
                    <div className="productDescContainer">
                        <div className="productDescImgContainer">
                            <img 
                            style={{ margin: '10px 0'}} 
                            src={generatePublicURL(product.productDetails.productImage[0].img)} alt={`${product.productDetails.productImage[0].img}`} 
                            />
                        </div>
